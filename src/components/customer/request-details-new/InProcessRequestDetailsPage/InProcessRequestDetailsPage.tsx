...
import styles from './InProcessRequestDetailsPage.module.css';
...
interface InProcessRequestDetailsPageProps {
  setActivePage: (page: string) => void;
  requestId: number;
  currentPage: number;
}

const InProcessRequestDetailsPage: React.FC<InProcessRequestDetailsPageProps> = ({
  setActivePage,
  requestId,
  currentPage
}) => {
  const requestType = 'in_process';
      ...
      <div className="container">
        ...
        >
          ...
          <div className="flex-grow-1 w-100">
            <RequestProgressBar currentStatus={request.status || 'in process'} />
          </div>
        </div>
          ...
          <div className={`col-12 ${styles.mainColLeft}`}>
            <div className={styles.frameDiv}>
              <RequestSummaryCard
                ...
                files={request.files || ''}
                RequestSummaryHeader="Arrived at Location"
              />

              {/* Button directly under summary on ≥1800px */}
...
export default InProcessRequestDetailsPage;
