...
const ExteriorServices: React.FC<ExteriorServicesProps> = ({ category }) => {
        ...
        <div className="card">
          <div className="card-header bg-soft-aqua border-bottom p-2">
            <h5 className="d-flex align-items-center main-services-title">
              <BackendImage
              useBackendUrl={false}
                src="/storage/images/category/yhaFDQILBratXeR8Y8LJ.webp"
                alt="Exterior Services"
                className="icon-services"
                placeholderText="No Image"
                transparentBackground={true}
              />
              <span className="ms-3">Exterior</span>
            </h5>
          </div>
          <div className="card-body p-3">
            <div className="text-center">
              <p>Loading exterior services...</p>
            </div>
          </div>
        </div>
      </div>
