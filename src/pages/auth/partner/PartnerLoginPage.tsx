                ...
                <div className="card">
                  <div className="card-body p-8 text-center">
                    ...
                    <form className="text-start mb-3 login-form" id="login-form" onSubmit={handleSubmit} noValidate={false}>
                      ...
                      <Link to="/signup/partner" className="btn btn-outline-primary rounded-pill btn-login w-100 mb-2">Sign up</Link>
                    </form>

                    <p className="mb-1 mobile-text-left">
                      <Link to="/forgot-password/partner" className="hover">Forgot Password?</Link>
                    </p>
                  </div>
                </div>
              </div>
