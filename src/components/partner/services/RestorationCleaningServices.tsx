...
interface RestorationCleaningServicesProps {
  category?: {
    id: number;
    title: string;
    slug: string;
...
const RestorationCleaningServices: React.FC<RestorationCleaningServicesProps> = ({ category }) => {
        ...
        <div className="card">
          <div className="card-header bg-soft-aqua border-bottom p-2">
            <h5 className="d-flex align-items-center main-services-title">
              <BackendImage
              useBackendUrl={false}
                src="/storage/images/category/e2VeITvo8eEpEcZG93dB.webp"
                alt="Restoration & Cleaning Services"
                className="icon-services"
                placeholderText="No Image"
                transparentBackground={true}
              />
              <span className="ms-3">Restoration & Cleaning</span>
            </h5>
          </div>
          <div className="card-body p-3">
            <div className="text-center">
              <p>Loading restoration & cleaning services...</p>
            </div>
          </div>
        </div>
      </div>
...
export default RestorationCleaningServices; 