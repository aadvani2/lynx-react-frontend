...
const GeneralContractingServices: React.FC<GeneralContractingServicesProps> = ({ category }) => {
        ...
        <div className="card">
          <div className="card-header bg-soft-aqua border-bottom p-2">
            <h5 className="d-flex align-items-center main-services-title">
              <BackendImage
              useBackendUrl={false}
                src="/storage/images/category/x9WOUcwoI7rdUxB6Pk1D.webp"
                alt="General Contracting Services"
                className="icon-services"
                placeholderText="No Image"
                transparentBackground={true}
              />
              <span className="ms-3">General Contracting</span>
            </h5>
          </div>
          <div className="card-body p-3">
            <div className="text-center">
              <p>Loading general contracting services...</p>
            </div>
          </div>
        </div>
      </div>
...
export default GeneralContractingServices; 