...
const InProgressRequestDetailsContent: React.FC<InProgressRequestDetailsContentProps> = ({ onBack, requestDetails, isLoading, error }) => {
            ...
            <div className="card-body p-3">
              <div className="d-flex align-items-center">
                ...
                <button className="btn btn-primary rounded-pill ms-auto btn-sm" id="callToAction" data-rid={requestDetails.request.id}>
                  On My Way <i className="uil uil-rocket px-1" style={{ fontSize: 15 }} />
                </button>
              </div>
