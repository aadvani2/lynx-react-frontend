    ...
    <div className="card-body">
      <div className="row">
        <div className="col-xxl-8 col-xl-12 col-md-12">
          <p>If you have any questions or need assistance, please contact Lynx Support:</p>
          <div className="d-flex flex-row mb-2 mt-4">
            <div>
              <div className="icon text-primary fs-24 me-4 mt-n1"><i className="uil uil-phone-volume" /></div>
            </div>
            <div>
          ...
          <div className="d-flex flex-row">
            <div>
              <div className="icon text-primary fs-24 me-4 mt-n1"><i className="uil uil-envelope" /></div>
            </div>
            <div>
              <h6 className="mb-1">E-mail</h6>
              <a href="mailto:hello@connectwithlynx.com" className="link-body link-email">hello@connectwithlynx.com</a>
            </div>
          </div>
        </div>
      </div>
