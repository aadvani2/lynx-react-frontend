...
interface AcceptedRequestDetailsContentProps {
...
const AcceptedRequestDetailsContent: React.FC<AcceptedRequestDetailsContentProps> = ({ onBack, requestDetails, isLoading, error }) => {
        ...
        <div className="col-lg-6">
          ...
          <div className="card mb-3">
            <div className="card-body p-3">
              ...
              <div className="d-flex align-items-center">
                <div style={{ width: '80px', height: '80px', objectFit: 'cover' }}>
                  <BackendImage
                    src={requestDetails.request.member.image}
                    alt={`${requestDetails.request.member.name} profile`}
                    ...
                    <tr className="border-bottom border-top">
                      ...
                      <td>
                        ...
                        <a href={`tel:${requestDetails.request.dial_code}${requestDetails.request.phone}`}>
                          <i className="uil uil-phone"></i>{requestDetails.request.dial_code} ({requestDetails.request.phone.substring(0, 3)}) {requestDetails.request.phone.substring(3, 6)}-{requestDetails.request.phone.substring(6)}
                        </a>
                      </td>
                    </tr>
                    <tr>
...
export default AcceptedRequestDetailsContent;
