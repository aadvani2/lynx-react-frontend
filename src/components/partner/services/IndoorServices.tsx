...
const IndoorServices: React.FC<IndoorServicesProps> = ({ category }) => {
        ...
        <div className="card">
          <div className="card-header bg-soft-aqua border-bottom p-2">
            <h5 className="d-flex align-items-center main-services-title">
              <BackendImage
              useBackendUrl={false}
                src="/storage/images/category/0NKxSWmHzLWGYGSrPNlX.webp"
                alt="Indoor Services"
                className="icon-services"
                placeholderText="No Image"
                // placeholderImage={iconFailedToLoad}
                transparentBackground={true}
              />
              <span className="ms-3">Indoor</span>
            </h5>
          </div>
          <div className="card-body p-3">
            <div className="text-center">
              <p>Loading indoor services...</p>
            </div>
          </div>
        </div>
      </div>
